...
\begin{enumerate}
    ...
    \item Closed. If the $\delta$-halo of $c$ is a Yes interval for all rational $\delta>0$, then $R(c:c) = 1$. Additionally, if $R(a:a)=0$, then there exists a $\delta$-halo of $a$ such that $R(a_\delta) = 0$.
\end{enumerate}
