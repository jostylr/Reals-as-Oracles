...
\begin{proof}
Take the midpoint (mediant works too, but we do not get explicit controls on lengths) of $a:b$, say $m$. Look at $f(m)$. If it is $v$, then we are done. If not, then we have several cases: 
\begin{enumerate}
...
We iterate this, continuing to choose the midpoints, thereby cutting the interval in half at each step. We can translate this into a fonsi and hence an Oracle, say $c$. 
